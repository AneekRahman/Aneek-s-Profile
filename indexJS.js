...
function hideShowSide(){
    switch(profileTrigger){
        case 0:
            ...
            proStyleSelect.innerHTML='#sideProfile::before{content: "";border: 10px solid;border-color: transparent transparent transparent #00bbff;font-size: 0;position: fixed;top: 45px;left: 100px;transform: scaleY(5.78) scaleX(2.5);display:block}';
            profileTrigger=1;
            break;
        case 1:
